            ...
            for el in elems:
                try:
                    ...
                    if tid and tid.IntegerValue != -1:
                        if tid.IntegerValue not in seen_type_ids:
                            seen_type_ids.add(tid.IntegerValue)
...
class ParamItem(object):
    def __init__(self, nome, match, chave=False, checked=True):
        self.Nome    = nome
        self.Match   = match
        self.Chave   = chave
...
<DataTemplate xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    def _atualizar_grid_params(self):
        ...
        for cab in self._cabecalhos:
            ...
            checked  = True if e_chave else prev.get(cab, match)
